...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKeyDown(KeyCode.RightShift) || Input.GetAxisRaw("Dash") > 0 && isPlayerDashAvailable == true)
        {
    ...
    public void Move()
    {
        inputHorizontalMoove = Input.GetAxisRaw("Horizontal");
        inputVerticalMoove = Input.GetAxisRaw("Vertical");
